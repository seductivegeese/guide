...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<jemoji>.freeze, ["= 0.6.2"])
      s.add_runtime_dependency(%q<jekyll-mentions>.freeze, ["= 1.1.2"])
      ...
      s.add_runtime_dependency(%q<jekyll-github-metadata>.freeze, ["= 2.0.0"])
      ...
      s.add_dependency(%q<jemoji>.freeze, ["= 0.6.2"])
      s.add_dependency(%q<jekyll-mentions>.freeze, ["= 1.1.2"])
      ...
      s.add_dependency(%q<jekyll-github-metadata>.freeze, ["= 2.0.0"])
